...
async function enviarMensaje(alumno) {
  ...
  const mensaje = `Hola ${alumno.Nombre}, desde Gymspace te informamos que tu plan vence el ${alumno.Fecha_vencimiento}. Si tenés alguna consulta, no dudes en escribirnos.`
